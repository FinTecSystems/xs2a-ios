...
class RadioButtonController {
	let tickedRadioImage = UIImage(named: "radio_ticked", in: .module, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
	let radioImage = UIImage(named: "radio", in: .module, compatibleWith: nil)?.withRenderingMode(.alwaysTemplate)
